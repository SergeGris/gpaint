...
void
gpaint_preview_widget_queue_redraw (GPaintPreviewWidget *widget)
{
  gtk_widget_queue_draw (GTK_WIDGET (widget));
}
...
GtkWidget *
gpaint_layers_widget_get_selected_toggle (GPaintLayersWidget *widget)
{
  return widget->selected_toggle;
}

cairo_surface_t *
gpaint_layers_widget_get_selected_surface (GPaintLayersWidget *widget)
{
  if (!widget->selected_toggle)
    return NULL;
  return g_object_get_data (G_OBJECT (widget->selected_toggle), "surface");
}

static void
update_delete_buttons (GPaintLayersWidget *widget)
{
...
static LayerRow *
create_layer_row (GPaintLayersWidget *widget, cairo_surface_t *surface)
{
...
void
gpaint_layers_widget_select_next (GPaintLayersWidget *widget)
{
...
void
gpaint_layers_widget_select_prev (GPaintLayersWidget *widget)
{
  if (!widget->selected_toggle || !widget->layer_rows)
    return;
  for (GList * l = widget->layer_rows; l != NULL; l = l->next)
