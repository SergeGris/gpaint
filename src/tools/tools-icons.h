...
extern const struct raw_bitmap picker_cursor_data;
extern const struct raw_bitmap bucket_data;
extern const struct raw_bitmap brush_data;
extern const struct raw_bitmap grab_data;
extern const struct raw_bitmap select_data;
